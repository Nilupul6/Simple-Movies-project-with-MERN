...
const CreateMovie = () => {
  ...
  const handleSaveMovie = (e) => {
    ...
    axios
      .post('http://localhost:3000/api/v1/movie', data)
      .then(() => {
        setLoading(false);
        navigate('/');
  ...
  return (
    <div className='p-4'>
      ...
      <form className='flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto' onSubmit={handleSaveMovie}>
        <div className='my-4'>
